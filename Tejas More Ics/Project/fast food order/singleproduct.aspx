<%@ Page Title="" Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="singleproduct.aspx.cs" Inherits="single" %>
            ...
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    <div class="welcome-text mt-5 mt-md-0">
                        ...
                        <a href="singleproduct.aspx?bid=<%=prod_id %>&pro_id=<%=product.pid %>&action=add" class="template-btn mt-3" onclick="javascript:alert('You must login or register')">Add To Cart</a>
                    </div>
                </div>
